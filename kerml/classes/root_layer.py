...
class Element(object):
    """
    An Element is a constituent of a model that is uniquely identified relative to all other
    Elements. It can have Relationships with other Elements. Some of these Relationships might
    imply ownership of other Elements, which means that if an Element is deleted from a model,
    then so are all the Elements that it owns.
    ...
    Attributes
        ...
        owningNamespace: Namespace [0..1] {subsets namespace}
            [Derived] The Namespace that owns this Element, derived as the
            membershipsOwningNamespace of the owningMembership of this Element, if any.
    ...
    def __init__(self, parent, name, humanId=None, aliasId=None, memberName=None,
...
class Relationship(Element):
    """
    A Relationship is an Element that relates two or more other Elements. Some of its
    relatedElements may be owned, in which case those ownedRelatedElements will be deleted from a
    model if their owningRelationship is. A Relationship may also be owned by another Element, in
    which case the ownedRelatedElements of the Relationship are also considered to be transitively
    owned by the owningRelatedElement of the Relationship.
    ...
    A "relationship Element" in the kernel abstract syntax is generically any Element that is an
    instance of either Relationship or a direct or indirect specialization of Relationship. Any
    other kind of Element is a "non-relationship Element". It is a convention of the kernel
    abstract syntax that non-relationship Elements are only related via reified relationship
    Elements. Any meta-associations directly between non-relationship Elements must be derived
    from underlying reified Relationships.
...
class Annotation(Relationship):
    ...
    Attributes
        ...
        owningAnnotatedElement : Element [0..1]
            {subsets annotatedElement, redefines owningRelatedElement}
            The annotatedElement of this Annotation, when it is also its owningRelatedElement.
    """

    def __init__(self, name, parent, annotatedElement=None, annotatingElement=None,
...
class OwnedDocumentation(Documentation):
    """
    Attributes
        documentingComment: str
            Documentation belonging to the element's parent
    """
...
class Import(Relationship):
    ...
    Attributes
        importedMemberName : String [0..1]
            The effectiveMemberName of the Membership of the importedNamespace to be imported.
        ...
        visibility : VisibilityKind
            The visibility level of the imported members from this Import relative to the
...
class ImportedNamespace(Import):
    ...
    def __init__(self, name, parent, importedName=None, importedNamespace=None,
                 importOwningNamespace=None):
        super(ImportedNamespace, self).__init__(name=name, parent=parent,
...
class Namespace(Element):
    ...
    in the Namespace. If a Membership specifies a memberName, then that is the name of the
    corresponding memberElement relative to the Namespace. Note that the same Element may be the
    memberElement of multiple Memberships in a Namespace (though it may be owned at most once),
    each of which may define a separate alias for the Element relative to the Namespace.

    Attributes
        importedMembership : Membership [0..*] {subsets membership, ordered}
            [Derived] The Memberships in this Namespace that result from Import Relationships between
            the Namespace and other Namespaces.
        ...
        ownedImport : Import [0..*] {subsets sourceRelationship, ownedRelationship, ordered}
            [Derived] The ownedRelationships of this Namespace that are Imports, for which the
            Namespace is the importOwningNamespace.
        ...
        ownedMembership : Membership [0..*]
            {subsets membership, sourceRelationship, ownedRelationship, ordered}
            [Derived] The ownedRelationships of this Namespace that are Memberships, for which the
            Namespace is the membershipOwningNamespace.
    """
    ...
    def __init__(self, name, parent, humanId=None, ownedRelationship=None,
        ...
        super(Namespace, self).__init__(name=name, parent=parent, humanId=humanId,
...
class Membership(Relationship):
    ...
    def isDistinguishableFrom(self, other) -> bool:
        """
        Whether this Membership is distinguishable from a given other Membership. By default, this
        is true if the memberName of this Membership is either empty or is different the memberName
        of the other Membership, or if the metaclass of the memberElement of this Membership is
        different than the metaclass of the memberElement of the other Membership. But this may be
...
class NonFeatureMember(Membership):
    ...
    def __init__(self, parent, name='NON_FEATURE_MEMBER', effectiveMemberName=None,
                 memberElement=None,
                 membershipOwningNamespace=None, ownedMemberElement=None,
                 visibility=None):
...
class NonFeatureElement(Element):
    ...
    Attributes
        ...
        documentationComment: Comment[0..*] {subsetsOwnedAnnotation, ordered}
            ...
            of the documentation of the Element.
        effectiveName:
            [Derived] The effective name to be used for this Element during name resolution
            within its owningNamespace.
        identifier: String
    ...
    def __init__(self, parent, name, ownedElement: Element, aliasId=None, humanId=None,
                 ownedRelationship=None,
                 owningMembership=None, owningNamespace=None, documentationComment=None,
                 ownedTextualRepresentation=None, ownedAnnotation=None, documentation=None,
                 derivedName=None, ):
